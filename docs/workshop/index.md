...
Vamos construir um sistema de **People Analytics** que pode:

1. **Analisar dados de funcionários** (turnover, satisfação, performance)
2. **Responder perguntas complexas** sobre tendências de RH
3. **Gerar relatórios executivos** automaticamente
4. **Identificar padrões** e fazer previsões
5. **Fornecer insights acionáveis** para tomada de decisão

!!! info "Caso de Uso Real"
    Baseado em cenários reais enfrentados por times de People Analytics em empresas de tecnologia, onde a análise de dados de RH é crucial para retenção de talentos e otimização de processos.
...
1. **Experimente com seus próprios dados** de RH
2. **Adicione novos agentes especializados** (ex: RecrutamentoAgent)
3. **Implemente feedback loops** para melhoria contínua
4. **Explore diferentes LLMs** e compare performance
5. **Construa interfaces** mais sofisticadas com Streamlit/Gradio

---

🎉 **Parabéns!** Você construiu um sistema completo de Agentic AI para People Analytics!
...
2. Open an issue on the [GitHub repository](https://github.com/DougTrajano/agentic-ai-workshop-pucrs25/issues)
3. Ask for help during the workshop
...
- Make sure to activate your virtual environment before installing packages
- If using conda, create a new environment: `conda create -n workshop python=3.11`

**Package installation failures**:
- Try upgrading pip: `pip install --upgrade pip`
- Use pip with no cache: `pip install --no-cache-dir -e .`

---

Ready to start building AI agents? Let's move on to the [workshop content](database.md)!
